@echo off
REM ===================================================================
REM  EasyMiniDirector launcher
REM  Double-click this file to start EasyMiniDirector.
...
:run
echo Starting EasyMiniDirector...
REM Launched with the windowless Python so no black box is left behind.
REM If startup fails, EasyMiniDirector.py puts the error in a message box, because
REM nothing printed here would ever be seen.
start "EasyMiniDirector" %PYW% "%~dp0EasyMiniDirector.py"
exit /b 0
